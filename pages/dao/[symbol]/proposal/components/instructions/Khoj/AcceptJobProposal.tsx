...
import { acceptProposal } from '@khoj-protocol/sdk/dist/cjs/apis'
...
const AcceptJobProposal = ({
  ...
  const [form, setForm] = useState<KhojAcceptJobProposalForm>({
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    if (
      ...
      const [transaction] = await acceptProposal(
        connection.current,
        wallet as any,
        {
...
export default AcceptJobProposal
